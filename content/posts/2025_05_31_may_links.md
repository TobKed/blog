...
> The article by Paul Graham discusses the importance of writing in spoken language to make writing more accessible and engaging. Graham argues that many writers adopt a formal and complex style that differs significantly from how they would speak to a friend. This style can make writing harder to read and understand, as it allows readers' attention to drift and gives writers a false sense of saying more than they actually are. He suggests that writing in spoken language can help convey complex ideas more clearly and make writing more relatable. Graham advises writers to revise their drafts by asking if each sentence is how they would say it in conversation and to read their work aloud to ensure it sounds natural. He acknowledges that while some forms of writing, like poetry, may benefit from a more formal style, most writing is better served by a conversational tone.
...
> Trail of Bits collaborated to optimize PyPI's test suite, reducing execution time from 163 seconds to 30 seconds while increasing the test count from 3,900 to over 4,700. Key optimizations included parallelizing test execution using pytest-xdist, leveraging Python 3.12's sys.monitoring for efficient coverage instrumentation, optimizing test discovery with testpaths configuration, and removing unnecessary imports. These changes resulted in an 81% performance improvement. The post emphasizes the importance of test performance as part of a security mindset, encouraging frequent testing and faster feedback loops.
