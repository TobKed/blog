...
I've been testing [superfile](https://superfile.dev/), an awesome TUI file manager, as a potential alternative to my long-time favorite, [lf](https://github.com/gokcehan/lf). It's always exciting to try new tools.

I also took a trip down memory lane by watching [Python: The Documentary | An origin story](http://www.youtube.com/watch?v=GfH4QL4VqJ0). It reminded me of my early days as a junior Python programmer, specifically a challenging yet rewarding task of rewriting an app from Python 2 to 3. It was a good reminder of how far I've come, and I'm happy for both the "good old times" and the present.

### [Python: The Documentary | An origin story](https://www.youtube.com/watch?v=GfH4QL4VqJ0)

<div class="videoWrapper" style="height:0; padding-bottom:56.25%; padding-top:25px; position:relative" height="0">
    <iframe style="position:absolute; top:0; width:100%" height="100%" width="100%" src="https://www.youtube-nocookie.com/embed/GfH4QL4VqJ0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
### [GitHub workflows tips and tricks](https://blog.frankel.ch/github-workflows-tips-tricks/)
...
### [rebase is dead long live the squabaserge](https://www.jonathancreamer.com/rebase-is-dead-long-live-the-squabaserge)
...
### [Operating Principles That Guided Me to Staff Engineer (Part 2: Expanding Influence) | High Growth Engineer | Jordan Cutler](https://read.highgrowthengineer.com/p/operating-principles-to-staff-part-2)

> Deliver more results through influence, relationships, and stronger communication

### [5 books that changed my engineering career forever | Tech World With Milan Newsletter](https://newsletter.techworld-with-milan.com/p/5-books-behind-my-growth-as-a-cto)
...
### [Your Ambition Is Not Enough | A Life Engineered | Steve Huynh](https://alifeengineered.substack.com/p/your-ambition-is-not-enough)

> Why the most ambitious people I know are the quickest to ask for help.

### [The Secret Sauce of Amazon's Execution | A Life Engineered | Steve Huynh](https://alifeengineered.substack.com/p/the-secret-sauce-of-amazons-execution)

> It’s not a tool or a process. It’s a specific mindset about agency that changes everything.

### [Are You Accumulating Career Debt? | A Life Engineered | Steve Huynh](https://alifeengineered.substack.com/p/are-you-accumulating-career-debt)

> Short-term comfort feels good, but building long-term equity feels better.

## AI

### [Solving the inference problem for open source AI projects with GitHub Models - The GitHub Blog](https://github.blog/ai-and-ml/llms/solving-the-inference-problem-for-open-source-ai-projects-with-github-models)

> How using GitHub’s free inference API can make your AI-powered open source software more accessible.

### [AI-Powered, Non-Intrusive Terminal Assistant](https://tmuxai.dev/)
...
### [Rate Limiting for Django Websites - DjangoTricks](https://www.djangotricks.com/blog/2025/07/rate-limiting-for-django-websites)
...
### [django.tasks exists :: TheOrangeOne](https://theorangeone.net/posts/django-dot-tasks-exists)

#### AI generated summary

The article announces the release of `django.tasks`, a new feature in Django that introduces background workers, available in the upcoming Django 6.0 release. It discusses the development process, contributions, and the significance of this feature for Django.

## Tools

### [JiraTUI - Where Jira Meets the Command Line](https://jiratui.sh)
...
### [For Good First Issue | Make your next open-source contribution matter.](https://forgoodfirstissue.github.com)
...
### [Jak stworzyć własny serwer MCP bez kodowania (n8n AI poradnik) - YouTube](https://www.youtube.com/watch?v=V8IGB4AfbHE)
...
### [Programming for Yourself - Paul Ganssle - YouTube](https://www.youtube.com/watch?v=NNbq-o5HODY)
...
### [Building Your Own Unified AI Assistant Using Claude Code - YouTube](https://www.youtube.com/watch?v=iKwRWwabkEc)
...
### [Claude Code - Jak dobrze korzystać? Tutorial: Budujemy fullstack’ową aplikację do booking’u barberów - YouTube](https://www.youtube.com/watch?v=JGOjYFn40xw)
...
### [How I Setup My Mac Terminal To Make It Amazing - YouTube](https://www.youtube.com/watch?v=oR_B2gQDVf4)
...
<div class="videoWrapper" style="height:0; padding-bottom:56.25%; padding-top:25px; position:relative" height="0">
    <iframe style="position:absolute; top:0; width:100%" height="100%" width="100%" src="https://www.youtube-nocookie.com/embed/IS_y40zY-hc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
