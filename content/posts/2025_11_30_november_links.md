Title: Month summary - November 2025
Date: 2025-11-30
Category: summary
...
### [How to Build Career Equity - by Steve Huynh](https://alifeengineered.substack.com/p/how-to-build-career-equity)

> We've talked about how to pay off our Career Debt. Now it's time to build the assets that set you free.

### [Dokumentowanie decyzji projektowych - o ADR i RFC - devszczepaniak.pl](https://devszczepaniak.pl/dokumentowanie-decyzji-projektowych-o-adr-i-rfc/)
...
### [Never forget anything. The engineer’s over-engineered… | by Jacob Bennett | Medium](https://jacob.blog/how-i-never-forget-anything-as-a-staff-software-engineer-8874d89a4d70)
...
### [Tech predictions for 2026 and beyond | All Things Distributed](https://www.allthingsdistributed.com/2025/11/tech-predictions-for-2026-and-beyond.html)
...
### [Open-source is broken: the sad story of Denis Pushkarev (core-js) | Izoukhai](https://www.izoukhai.com/blog/the-sad-story-of-denis-pushkarev-zloirock-the-creator-of-core-js)
...
### [The Smartest Person in the Room Asks the 'Dumbest' Questions](https://alifeengineered.substack.com/p/the-smartest-person-in-the-room-asks)
...
### [Gemini CLI Tips & Tricks - by Addy Osmani - Elevate](https://addyo.substack.com/p/gemini-cli-tips-and-tricks)
...
### [Przejęli mu konto, ale pomoc techniczna Google nie chce mu pomóc -- Niebezpiecznik.pl](https://niebezpiecznik.pl/post/przejete-konto-google-gmail-jak-odzyskac-pomoc-suport-kontakt/)
...
### [EY exposed 4TB SQL backup file to open web, researchers say • The Register](https://www.theregister.com/2025/10/29/ey_exposes_4tb_sql_database/)
...
### [GitHub - Ankit404butfound/PyWhatKit](https://github.com/Ankit404butfound/PyWhatKit)
...
### [GitHub - ulern-com/graflow-django](https://github.com/ulern-com/graflow-django/)
...
### [GitHub Project Search and Discovery - GitDB](https://gitdb.net/)
...
### [GitHub - hunvreus/devpush: Like Vercel, but open source and for all languages.](https://github.com/hunvreus/devpush)

> Like Vercel, but open source and for all languages. - hunvreus/devpush

## Cloud

### [Deploying and Running n8n on Google Cloud Run - Google Codelabs](https://codelabs.developers.google.com/n8n-cloud-run?hl=en)
...
### [How to Host a single-turn ADK Agent on a Cloud Run worker pool - Google Codelabs](https://codelabs.developers.google.com/codelabs/cloud-run/host-adk-agent-worker-pool-single-turn)
...
### [CZM Rewind: The Truth About Software Development with Carl Brown - Better Offline - Omny.fm](https://omny.fm/shows/better-offline/czm-rewind-the-truth-about-software-development-with-carl-brown)
...
### [Episode #272: Michael Kennedy: Managing Your Own Python Infrastructure – The Real Python Podcast](https://realpython.com/podcasts/rpp/272/)
...
### [Episode #524 - 38 things Python developers should learn in 2025 | Talk Python To Me Podcast](https://talkpython.fm/episodes/show/524/38-things-python-developers-should-learn-in-2025)
...
### [PyBay 2025 YouTube Playlist](https://www.youtube.com/playlist?list=PL85KuAjbN_gseSuHZTUCgNAHLeKuMDBxI)

> PyBay is the largest python regional conference in the San Francisco Bay area - and 2025 was PyBay's 10th Anniversary!

### [DjangoCon US 2025 YouTube Playlist](https://youtube.com/playlist?list=PL2NFhrDSOxgUSZVGkmbMhUpaaZ1ORfpCl)

> Videos from DjangoCon US 2025 in Chicago

### [You SUCK at Prompting AI (Here's the secret) - YouTube](https://www.youtube.com/watch?v=pwWBcsxEoLk)
...
### [I Spent $10,000 Learning How To Talk (Here's What Actually Worked) - YouTube](https://www.youtube.com/watch?v=-JlFfVkTymo)
...
### [no one sees it coming (except Google) - YouTube](https://www.youtube.com/watch?v=LQfSfVFc4Ss)
...
### [The future of Python and AI with Guido van Rossum - YouTube](https://www.youtube.com/watch?v=cMRvgR8EpOE)

<div class="videoWrapper" style="height:0; padding-bottom:56.25%; padding-top:25px; position:relative" height="0">
    <iframe style="position:absolute; top:0; width:100%" height="100%" width="100%" src="https://www.youtube-nocookie.com/embed/cMRvgR8EpOE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
